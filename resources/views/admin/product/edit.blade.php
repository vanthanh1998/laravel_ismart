                        ...
                        <div class="box-body">
                            <div class="col-md-9">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="desc" id="desc" class="editor1">{!! old('desc'),isset($product) ? $product['desc'] :null !!}</textarea>
                                    <span class="error">{!! $errors->first('desc') !!}</span>
                                </div>
                                <div class="form-group">
                                    <label for="content">Nội dung</label>
                                    <textarea name="content" id="content" class="editor2">{!! old('content'),isset($product) ? $product['content'] :null !!}</textarea>
