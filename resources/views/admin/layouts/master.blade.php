...
<head>
    ...
    <link href="{{ url('admin/js/bootstrap/bootstrap-toggle.min.css') }}" rel="stylesheet" type="text/css"/>
    <link href="{{ url('admin/css/font-awesome/css/font-awesome.min.css') }}" rel="stylesheet" type="text/css"/>

    <!-- Page level plugin CSS-->
    <link href="{{ url('admin/datatables/dataTables.bootstrap4.css') }}" rel="stylesheet">
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('admin/css/import/style.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ url('admin/css/import/responsive.css') }}">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="{{ asset('upload/admin/'.Auth::guard('admin')->user()->avatar) }}" class="user-image" alt="User Image">
                        <span class="hidden-xs">{!! Auth::guard('admin')->user()->fullname !!}</span>
                    </a>
                    <ul class="dropdown-menu">
                        <!-- User image -->
                        <li class="user-header">
                            <img src="{{ asset('upload/admin/'.Auth::guard('admin')->user()->avatar) }}" class="img-circle" alt="User Image">
                            <p>
