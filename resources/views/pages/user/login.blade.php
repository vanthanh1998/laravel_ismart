...
{{--            <label class="pull-left checkbox-inline"><input type="checkbox"> Remember me</label>--}}
            <a href="{!! url('quen-mat-khau') !!}" class="pull-right">Forgot Password?</a>
        </div>
        ...
        <p class="text-center text-muted small">Don't have an account? <a href="{{ url('dang-ky')  }}">Sign up here!</a></p>
