                    ...
                    <form action="{{ route('post.info') }}" id="info_customer" class="update_account" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="display_name" value="{!! old('display_name'),Auth::user()->fullname !!}" placeholder="Họ & tên">
                            </div>
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="username" value="{!! Auth::user()->username !!}" placeholder="Tên đăng nhập" readonly="readonly">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="email" class="form-control" name="user_email" value="{!! old('user_email'),Auth::user()->email  !!}" placeholder="Email">
                            </div>
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="user_address" value="{!! old('user_address'),Auth::user()->address  !!}" placeholder="Địa chỉ">
                            </div>
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="user_tel" value="{!! old('user_tel'),Auth::user()->phone  !!}" placeholder="Số điện thoại">
                            </div>
