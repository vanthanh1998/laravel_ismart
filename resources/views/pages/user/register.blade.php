        ...
        <form action="" id="form-bs-register" method="post">
            ...
            <div class="form-group">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="fullname" value="{!! old('fullname') !!}" placeholder="Họ & tên">
                </div>
            ...
            <div class="text-center">Already have an account? <a href="{{ url('dang-nhap') }}">Login here</a></div>
        </form>
    </div>
@endsection
@section('script')
