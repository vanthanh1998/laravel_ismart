...
<div id="main-content-wp" class="clearfix blog-page"style="background: #f7f7f7;padding-top: 25px;padding-bottom: 75px;">
    ...
    <div id="wrapper" class="wp-inner clearfix">
        ...
        <div class="section" style="float: left">
            <a class="btn btn-info" href="{{ url('lichsugiaodich/'.Auth::user()->id) }}">Quay lại</a>
        </div>
        <div class="section" style="float: right;font-size: 20px;font-weight: 300">
            <div class="section-detail">
                <p class="btn btn-xs btn-success">Tổng số lượng:</p> <span>{{ $total_qty }} sản phẩm</span><br>
                <p class="btn btn-xs btn-success">Tổng đơn hàng:</p> <span>{!! number_format($total_price,0,",",",") !!} đ</span>
            </div>
        </div>
    </div>
</div>
