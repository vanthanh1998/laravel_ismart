...
{{--                        <div id="num-order-wp">--}}
{{--                            <button type="submit" title="" id="minus"><i class="fa fa-minus"></i></button>--}}
{{--                            <input type="text" name="num_order" class="sl_{!! $ctsp['id'] !!}" value="1" id="num-order">--}}
{{--                            <button type="submit" title="" id="plus"><i class="fa fa-plus"></i></button>--}}
{{--                        </div>--}}
                        <div class="product-icon-container">
                            <div class="product-icon-container">
                                <a href="{!! route('add.cart',$ctsp->id) !!}"  title="Thêm giỏ hàng" class="add-cart">Thêm giỏ hàng</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="component_rating" style="margin-bottom: 20px">
                            ...
                            @foreach($arrayRatings as $key => $item)
                                ...
                                <div class="item_rating" style="display: flex;align-items: center;">
                                    ...
                                    <div style="width:70%;margin: 0 20px;">
                                        <span style="width: 100%;height: 8px;display: block;border:1px solid #dedede;border-radius: 5px;background-color:#dedede "><b style="width: {!! $itemAge !!}%;background-color: #f25800;display: block;height: 100%;border-radius: 5px;"></b></span>
                                    </div>
                                    <div style="width:20%">
                                        <a href="">{!! $item['total'] !!} đánh giá </a>
                                    </div>
                                </div>
                            @endforeach
                        </div>
                    ...
                    <div class="form_rating hide">
                        ...
                        <div style="margin-top: 15px;">
                            @if(Auth::check())
                            <a href="{!! route('post.save.products',$ctsp->id) !!}" class="js_rating_product" style="width: 200px;background: #288ad6;padding: 10px;color: white;border-radius: 5px;">Gửi đánh giá</a>
                            @else
                            <a href="{!! url('dang-nhap') !!}" onclick="return confirm_delete('Bạn cần phải đăng nhập trước khi gửi đánh giá!')" style="width: 200px;background: #288ad6;padding: 10px;color: white;border-radius: 5px;">Gửi đánh giá</a>
                            @endif
                        </div>
                    </div>
                    <br>
                    <div class="component_list_rating">
                        @if(isset($danhgia))
                            ...
                            <div class="rating_item" style="margin: 10px 0">
                                <div>
                                    <span style="color: #333;font-weight: bold;text-transform: capitalize;">{{isset($item->user->fullname)? $item->user->fullname : ''}}</span>
