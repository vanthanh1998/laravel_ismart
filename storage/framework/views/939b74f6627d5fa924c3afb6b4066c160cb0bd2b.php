        ...
        <div id="content" class="fl-right">
            ...
            <div class="section" id="title-page">
                <div class="clearfix">
                    ...
                    <a href="<?php echo route('get.add.cate_product'); ?>" title="" id="add-new" class="fl-left">Thêm mới</a>
                </div>
            </div>
            <div class="section" id="detail-page">
                <div class="section-detail">
                    <div class="filter-wp clearfix">
                        ...
                        <form method="GET" action="<?php echo route('get.search.cate'); ?>" class="form-s fl-right">
                    ...
                    <div class="table-responsive">
                        <table class="table list-table-wp">
                            ...
                            <tbody>
                            <?php $stt = $cate->perPage() * ($cate->currentPage() -1); ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo route('get.edit.cate_product',$item->id); ?>" class="btn btn-info btn-xs">
                                            <i class="fa fa-pencil"></i> Chỉnh sửa
                                        </a>
                                        <a href="<?php echo route('get.delete.cate_product',$item->id); ?>" class="btn btn-danger btn-xs" onclick="return confirm_delete('Bạn muốn xóa danh mục sản phẩm này!')">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp_7\htdocs\laravel_it_viec\ismart\resources\views/admin/cate_product/list.blade.php ENDPATH**/ ?>