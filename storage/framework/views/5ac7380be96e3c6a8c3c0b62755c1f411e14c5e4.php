    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Bill Transport</li>
            </ol>
        </section>
        <!-- Main content -->
    ...
    <script>
        $(document).ready(function(){
            ...
            var dataTable = $('#bill_table').DataTable({
                ...
                ajax: {
                    url: "<?php echo e(route('get.data.transport')); ?>",
                    type:'post',
                },
                order: [[ 1, 'asc' ]],
                columns: [
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp_7\htdocs\ismart\resources\views/admin/bill/danhsachvanchuyen.blade.php ENDPATH**/ ?>