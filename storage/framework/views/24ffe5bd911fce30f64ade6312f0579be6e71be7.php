        ...
        <div id="content" class="fl-right">
                ...
                <div class="section-detail">
                    ...
                    <div class="table-responsive">
                        <table class="table list-table-wp">
                            ...
                            <tbody>
                            <?php $stt = $product->perPage() * ($product->currentPage() -1); ?>
            ...
            <div class="section" id="paging-wp">
                <div class="section-detail clearfix">
                    <p class="num_rows">Có <?php echo count($search_product); ?> sản phẩm trong hệ thống</p>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp_7\htdocs\laravel_it_viec\ismart\resources\views/admin/product/list.blade.php ENDPATH**/ ?>