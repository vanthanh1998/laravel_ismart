        ...
        <form action="" id="form-bs-register" method="post">
            ...
            <div class="form-group">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="fullname" value="<?php echo old('fullname'); ?>" placeholder="Họ & tên">
                </div>
            ...
            <div class="form-group">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="username" value="<?php echo old('username'); ?>" placeholder="Tên đăng nhập">
                </div>
            ...
            <div class="form-group">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="address" value="<?php echo old('address'); ?>" placeholder="Địa chỉ">
                </div>
            ...
            <div class="form-group">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="phone" value="<?php echo old('phone'); ?>" placeholder="Số điện thoại">
                </div>
            ...
            <div class="form-group" id="captcha">
                ...
                <div class="captcha_icon_refresh">
                    <a href="javascript:void(0);" onclick="refreshCaptcha()" id="captcha_refresh">
                        <img class="icon_refresh" src="<?php echo e(asset('images/refresh.png')); ?>">
                    </a>
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="captcha" id="captcha" placeholder="Hình ảnh xác thực">
                </div>
...
<?php echo $__env->make('layout.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\laravel_ismart\resources\views/pages/user/register.blade.php ENDPATH**/ ?>