...
<head>
    ...
    <link href="<?php echo e(url('admin/js/bootstrap/bootstrap-toggle.min.css')); ?>" rel="stylesheet" type="text/css"/>
    <link href="<?php echo e(url('admin/css/font-awesome/css/font-awesome.min.css')); ?>" rel="stylesheet" type="text/css"/>

    <!-- Page level plugin CSS-->
    <link href="<?php echo e(url('admin/datatables/dataTables.bootstrap4.css')); ?>" rel="stylesheet">
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('admin/css/import/style.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('admin/css/import/responsive.css')); ?>">
    ...
    <script src="<?php echo e(url('admin/js/bootstrap/bootstrap-toggle.min.js')); ?>" type="text/javascript"></script>
    <script src="<?php echo e(url('admin/js/plugins/ckeditor5/ckeditor.js')); ?>" type="text/javascript"></script>
    <script src="<?php echo e(url('admin/js/main.js')); ?>" type="text/javascript"></script>
    <script src="<?php echo e(url('admin/js/myscript.js')); ?>" type="text/javascript"></script>
    <script src="<?php echo e(url('admin/js/check.js')); ?>" type="text/javascript"></script>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="<?php echo e(asset('upload/admin/'.Auth::guard('admin')->user()->avatar)); ?>" class="user-image" alt="User Image">
                        <span class="hidden-xs"><?php echo Auth::guard('admin')->user()->fullname; ?></span>
                    </a>
                    <ul class="dropdown-menu">
                        <!-- User image -->
                        <li class="user-header">
                            <img src="<?php echo e(asset('upload/admin/'.Auth::guard('admin')->user()->avatar)); ?>" class="img-circle" alt="User Image">
                            <p>
...
<?php /**PATH D:\xampp\htdocs\laravel_ismart\resources\views/admin/layouts/master.blade.php ENDPATH**/ ?>