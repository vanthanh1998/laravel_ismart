    ...
    <div class="wp-inner">
        ...
        <div class="main-content fl-right">
            <div class="section" id="list-blog-wp">
                ...
                <?php else: ?>
                <p>Không có bài viết nào trong danh mục <?php echo $cate_post['name']; ?></p>
                <?php endif; ?>
            </div>
...
<?php echo $__env->make('layout.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp_7\htdocs\laravel_it_viec\ismart\resources\views/pages/post/cate_blog.blade.php ENDPATH**/ ?>