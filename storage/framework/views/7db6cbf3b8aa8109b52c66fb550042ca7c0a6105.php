...
<div id="menu-respon">
    <?php if(Auth::check()): ?>
    <a href="<?php echo url('/'); ?>" title="" class="logo">Hello! <strong><?php echo e(Auth::User()->fullname); ?></strong></a>
    <?php else: ?>
    <a href="<?php echo url('/'); ?>" title="" class="logo">ISMART</a>
    <?php endif; ?>
...
<?php /**PATH G:\xampp_7\htdocs\laravel_it_viec\ismart\resources\views/layout/footer.blade.php ENDPATH**/ ?>