                        ...
                        <?php $__currentLoopData = $bill; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button class="tbody-text btn btn-xs btn-warning"><i class="fa fa-eye" aria-hidden="true"></i></button>
                                    <?php if($item['status'] == 0): ?>
...
<?php /**PATH G:\xampp_7\htdocs\laravel_it_viec\ismart\resources\views/pages/history/lichsugiaodich.blade.php ENDPATH**/ ?>