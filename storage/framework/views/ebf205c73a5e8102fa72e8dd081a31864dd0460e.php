       	...
       	<?php if(!empty(Cart::content())): ?>
	        ...
	        <tbody>
	            <tr>
	                ...
	                <td><img src="<?php echo e(asset('resources/upload/product/'.$item->options->img)); ?>" alt=""></td>
...
<?php /**PATH G:\xampp_7\htdocs\laravel_it_viec\ismart\resources\views/emails/checkout_email.blade.php ENDPATH**/ ?>