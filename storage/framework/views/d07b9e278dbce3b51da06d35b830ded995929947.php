                    ...
                    <ul class="list-item">
                        ...
                        <li class="clearfix">
                            <a href="<?php echo url('chi-tiet-bai-viet',[$item['id'],$item['alias']]); ?>" title="" class="thumb fl-left">
                                <img src="<?php echo e(asset('upload/post/'.$item['image'])); ?>" alt="">
                            </a>
...
<?php echo $__env->make('layout.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\laravel_ismart\resources\views/pages/post/list_blog.blade.php ENDPATH**/ ?>