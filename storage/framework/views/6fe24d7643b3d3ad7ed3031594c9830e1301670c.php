            ...
            <div class="col-md-9">
                <div class="profile-content">
                    <form class="change_password_bs" method="post">
                        <?php echo csrf_field(); ?>
                        <h2 style="font-size: 20px;">Thay đổi mật khẩu</h2><br>
                        <div class="form-group">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-lock"></i></span>
                                <input type="password" class="form-control" id="password_old" name="password_old" placeholder="Mật khẩu cũ">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <i class="fa fa-check"></i>
                                ...
                                <input type="password" class="form-control" name="password_confirm" placeholder="Nhập lại mật khẩu mới">
                            </div>
...
<?php echo $__env->make('layout.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp_7\htdocs\laravel_it_viec\ismart\resources\views/pages/user/change_pass.blade.php ENDPATH**/ ?>