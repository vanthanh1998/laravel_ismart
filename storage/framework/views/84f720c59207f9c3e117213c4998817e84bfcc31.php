                    ...
                    <form action="<?php echo e(route('post.info')); ?>" id="info_customer" class="update_account" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="display_name" value="<?php echo old('display_name'),Auth::user()->fullname; ?>" placeholder="Họ & tên">
                            </div>
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="username" value="<?php echo Auth::user()->username; ?>" placeholder="Tên đăng nhập" readonly="readonly">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="user_address" value="<?php echo old('user_address'),Auth::user()->address; ?>" placeholder="Địa chỉ">
                            </div>
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="user_tel" value="<?php echo old('user_tel'),Auth::user()->phone; ?>" placeholder="Số điện thoại">
                            </div>
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <select class="form-control" name="sltgender" title="Giới tính">
...
<?php echo $__env->make('layout.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp_7\htdocs\ismart_true\resources\views/pages/user/update_info_account.blade.php ENDPATH**/ ?>