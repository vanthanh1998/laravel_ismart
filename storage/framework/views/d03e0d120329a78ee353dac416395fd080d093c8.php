    ...
    <div class="contact-form">
        <form action="" method="post" id="form-contact-mobile">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="name_contact" value="<?php echo old('name_contact'); ?>">
                <span class="error name_contact_error" style="display: none;color:red"></span>
            </div>
            <div class="form-group">
                <label for="email_contact">Email Address</label>
                <input type="email" class="form-control" name="email_contact" value="<?php echo old('email_contact'); ?>">
...
<?php echo $__env->make('layout.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp_7\htdocs\laravel_it_viec\ismart\resources\views/pages/contact/lienhe.blade.php ENDPATH**/ ?>