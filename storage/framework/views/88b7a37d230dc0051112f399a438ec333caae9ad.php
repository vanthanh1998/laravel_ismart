<ul class="sidebar-menu" data-widget="tree">
    ...
    <li class="treeview">
        ...
        <ul class="treeview-menu">
            <li><a href="<?php echo e(route('get.list.bill')); ?>"><i class="fa fa-circle-o"></i> Chờ duyệt</a></li>
            <li><a href="<?php echo e(route('get.list.vanchuyen')); ?>"><i class="fa fa-circle-o"></i> Vận chuyển</a></li>
            <li><a href="<?php echo e(route('get.list.thanhtoan')); ?>"><i class="fa fa-circle-o"></i> Đã thanh toán</a></li>
        </ul>
    </li>
...
<?php /**PATH E:\xampp\htdocs\ismart_true\resources\views/admin/layouts/sidebar.blade.php ENDPATH**/ ?>