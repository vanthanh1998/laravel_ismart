...
<head>
    ...
    <link href="<?php echo url('css/import/blog.css'); ?>" rel="stylesheet" type="text/css"/>
    <link href="<?php echo url('css/import/fonts.css'); ?>" rel="stylesheet" type="text/css"/>
    <link href="<?php echo url('css/import/footer.css'); ?>" rel="stylesheet" type="text/css"/>
    <link href="<?php echo url('css/import/global.css'); ?>" rel="stylesheet" type="text/css"/>
    <link href="<?php echo url('css/import/header.css'); ?>" rel="stylesheet" type="text/css"/>
    <link href="<?php echo url('css/import/category_product.css'); ?>" rel="stylesheet" type="text/css"/>
    <link href="<?php echo url('css/import/login.css'); ?>" rel="stylesheet" type="text/css"/>
    <link href="<?php echo url('toastr/toastr.min.css'); ?>" rel="stylesheet" type="text/css"/>
    <link href="<?php echo url('responsive_history.css'); ?>" rel="stylesheet" type="text/css"/>
...
<div id="main-content-wp" class="clearfix blog-page"style="background: #f7f7f7;padding-top: 25px;padding-bottom: 75px;">
    ...
    <div id="wrapper" class="wp-inner clearfix">
        ...
        <div class="section" style="float: left">
            <a class="btn btn-info" href="<?php echo e(url('lichsugiaodich/'.Auth::user()->id)); ?>">Quay lại</a>
        </div>
        <div class="section" style="float: right;font-size: 20px;font-weight: 300">
            <div class="section-detail">
                <p class="btn btn-xs btn-success">Tổng số lượng:</p> <span><?php echo e($total_qty); ?> sản phẩm</span><br>
                <p class="btn btn-xs btn-success">Tổng đơn hàng:</p> <span><?php echo number_format($total_price,0,",",","); ?> đ</span>
            </div>
        </div>
    </div>
</div>
...
<?php /**PATH D:\xampp\htdocs\laravel_ismart\resources\views/pages/history/chitiethoadonkh.blade.php ENDPATH**/ ?>