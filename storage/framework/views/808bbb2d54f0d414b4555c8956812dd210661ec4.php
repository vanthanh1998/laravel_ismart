                ...
                <div class="section-detail clearfix">
                    <div class="thumb-wp fl-left">
                        <a href="" id="main-thumb" class="clearfix">
                            <div style="height:356px;width:356px;" class="zoomWrapper"><img id="zoom" src="<?php echo e(asset('upload/product/'.$ctsp['image'])); ?>" data-zoom-image="<?php echo e(asset('upload/product/'.$ctsp['image'])); ?>" style="position: absolute;"></div>
                        </a>
                        <div id="list-thumb">
                            ...
                            <a href="" data-image="<?php echo e(asset('upload/product_detail/'.$item['image'])); ?>" data-zoom-image="<?php echo e(asset('upload/product_detail/'.$item['image'])); ?>">
                                <img id="zoom-img" src="<?php echo e(asset('upload/product_detail/'.$item['image'])); ?>" />
                            </a>
                    ...
                    <div class="thumb-respon-wp fl-left">
                        <img src="<?php echo e(asset('upload/product/'.$ctsp['image'])); ?>" alt="">
                    </div>
...
<?php echo $__env->make('layout.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\laravel_ismart\resources\views/pages/product/detail_product.blade.php ENDPATH**/ ?>