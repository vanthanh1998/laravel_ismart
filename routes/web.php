...
Route::post('/search', 'SearchController@postSearch')->name('post.search');
...
Route::group(['prefix'=>'admin','middleware'=>'CheckLoginAdmin'],function(){
	...
	Route::group(['prefix'=>'product'],function(){
		...
		Route::get('add','ProductController@get_add')->name('get.add.product');
		Route::post('add','ProductController@post_add');

		Route::get('edit/{id}','ProductController@get_edit')->name('get.edit.product');
