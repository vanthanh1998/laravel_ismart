        ...
        $.ajax({
            ...
            success:function(data){
                ...
                if(data.error == true){
                    ...
                    // $('#confirm-success').on('show.bs.modal', function(e) {
                    //     $('.list li').remove();
                    //     // text
                    //     $('form input[type=text]').each(function(){
                    //         textTitle = $(this).attr('title');
                    //         textValue = $(this).val();
                    //         $('.list').append('<li>'+ textTitle + ':'+ textValue +'</li>');
                    //     });
                    //     // email
                    //     var emailTitle = $('form input[type=email]').attr('title');
                    //     var emailValue = $('form input[type=email]').val();
                    //     $('.list').append('<li>'+ emailTitle + ':'+ emailValue +'</li>');
                    //     //select
                    //     var genderTitle = $('select').attr('title');
                    //     var genderValue = $('select option').val();
                    //     $('.list').append('<li>'+ genderTitle + ':'+ genderValue +'</li>');
                    //     saveRegister();
                    // });
                    // $('#confirm-success').modal('show');
                    // $('#confirm-success').on('hidden.bs.modal',function(){
